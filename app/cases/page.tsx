...
const cases = [
  ...
  {
    id: 'CASE-2024-003',
    title: 'Global Merge Co. Acquisition',
    type: 'Corporate',
    status: 'Active',
    client: 'Global Merge Co.',
  ...
  {
    id: 'CASE-2024-004',
    title: 'CryptoChain Securities Compliance',
    type: 'Securities',
    status: 'Active',
    client: 'CryptoChain Ltd.',
  ...
  {
    id: 'CASE-2024-005',
    title: 'SoundStream Copyright Dispute',
    type: 'IP Litigation',
    status: 'Active',
    client: 'SoundStream Media',
    lastUpdated: '2024-03-24',
    nextDeadline: '2024-04-20',
    progress: 70,
    risk: 'medium',
    billingStatus: 'Current',
    aiInsights: {
      sentiment: 'positive',
      predictedOutcome: '80% favorable',
      similarCases: 8,
      documentCount: 63,
    },
  },
  {
    id: 'CASE-2024-006',
    title: 'EcoTech International Merger',
    type: 'Corporate',
    status: 'Pending',
  ...
  {
    id: 'CASE-2024-007',
    title: 'DataSafe Privacy Compliance',
    type: 'Data Protection',
    status: 'Active',
    client: 'DataSafe Corp',
    lastUpdated: '2024-03-22',
    nextDeadline: '2024-04-25',
    progress: 55,
    risk: 'medium',
    billingStatus: 'Overdue',
    aiInsights: {
      sentiment: 'neutral',
      predictedOutcome: '70% favorable',
      similarCases: 6,
      documentCount: 89,
    },
  },
  ...
  {
    id: 'CASE-2024-009',
    title: 'CloudNet Trademark Infringement',
    type: 'IP Litigation',
    status: 'Active',
    client: 'CloudNet Services',
    lastUpdated: '2024-03-20',
    nextDeadline: '2024-04-18',
    progress: 75,
    risk: 'low',
    billingStatus: 'Current',
    aiInsights: {
  ...
  {
    id: 'CASE-2024-010',
    title: 'RoboTech Employment Dispute',
    type: 'Employment',
    status: 'Pending',
  ...
  {
    id: 'CASE-2024-011',
    title: 'QuantumCompute Licensing Dispute',
    type: 'IP Litigation',
    status: 'Active',
    client: 'QuantumCompute Labs',
    lastUpdated: '2024-03-18',
    nextDeadline: '2024-05-12',
    progress: 60,
    risk: 'high',
    billingStatus: 'Current',
    aiInsights: {
      sentiment: 'neutral',
      predictedOutcome: '50% favorable',
      similarCases: 2,
      documentCount: 84,
    },
  },
  {
    id: 'CASE-2024-012',
    title: 'GreenEnergy Regulatory Compliance',
    type: 'Environmental',
    status: 'Active',
    client: 'GreenEnergy Solutions',
    lastUpdated: '2024-03-17',
    nextDeadline: '2024-04-28',
    progress: 85,
    risk: 'low',
    billingStatus: 'Current',
    aiInsights: {
      sentiment: 'positive',
      predictedOutcome: '95% favorable',
      similarCases: 5,
      documentCount: 43,
    },
  },
  {
    id: 'CASE-2024-013',
    title: 'MetaVerse Platform Rights',
    type: 'IP Litigation',
    status: 'Active',
    client: 'MetaVerse Tech',
    lastUpdated: '2024-03-16',
    nextDeadline: '2024-05-08',
    progress: 50,
    risk: 'high',
    billingStatus: 'Pending',
    aiInsights: {
  ...
  {
    id: 'CASE-2024-014',
    title: 'AeroSpace Defense Contracts',
  ...
  {
    id: 'CASE-2024-015',
    title: 'FinTech Securities Offering',
    type: 'Securities',
    status: 'Pending',
    client: 'FinTech Global',
    lastUpdated: '2024-03-14',
    nextDeadline: '2024-05-18',
    progress: 40,
    risk: 'medium',
    billingStatus: 'Current',
    aiInsights: {
  ...
  {
    id: 'CASE-2024-016',
    title: 'SmartDevice Patent Portfolio',
    type: 'Patent Litigation',
    status: 'Active',
    client: 'SmartDevice Technologies',
    lastUpdated: '2024-03-13',
    nextDeadline: '2024-05-22',
    progress: 55,
    risk: 'high',
    billingStatus: 'Current',
    aiInsights: {
